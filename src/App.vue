 ...
 * @LastEditors: yingzi
 * @LastEditTime: 2024-08-21 20:26:39
 -->
<template>
  <div id="app" name="app">
    <el-container>
...
export default {
  ...
  created() {
    ...
    //   })
    //   .then(res => {
    //     //console.log('------------>shoppingCart()----------->res@@',res);
    //     //this.shoppingCartArr = res.data.data;
    //     //遍历数组
    //     // const shoppingCart = {
    //     //   id: "", // 购物车id
    //     //   productID: "", // 商品id
    ...
    //     //   check: false // 是否勾选
    //     // }
    //     const shoppingCartArr = res.data.data;
    //     for (let index = 0; index < shoppingCartArr.length; index++) {
    //       const element = shoppingCartArr[index];
    //       element['check']=true;//添加属性;
    //       element['maxNum']=10;//限购数量10
    //     }
    //     this.setShoppingCart(shoppingCartArr);//设置数组;
    //   })
    //   .catch(err => {
  ...
  methods: {
    ...mapActions(["setUser", "setShowLogin", "setShoppingCart","setShoppingCart"]),
    login() {
